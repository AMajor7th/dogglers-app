...
public final class GridListItemBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView hobbiesItem;
  ...
  private GridListItemBinding(@NonNull MaterialCardView rootView, @NonNull TextView ageItem,
      @NonNull TextView hobbiesItem, @NonNull ImageView imageItem, @NonNull TextView nameItem) {
    this.rootView = rootView;
    this.ageItem = ageItem;
    this.hobbiesItem = hobbiesItem;
  ...
  public static GridListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.age_item;
      TextView ageItem = ViewBindings.findChildViewById(rootView, id);
      if (ageItem == null) {
        break missingId;
      }

      id = R.id.hobbies_item;
      TextView hobbiesItem = ViewBindings.findChildViewById(rootView, id);
      if (hobbiesItem == null) {
        break missingId;
      }
      ...
      return new GridListItemBinding((MaterialCardView) rootView, ageItem, hobbiesItem, imageItem,
          nameItem);
    }
